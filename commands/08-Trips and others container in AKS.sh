...
curl -i -X PATCH --header 'Content-Type: application/json' --header 'Accept: application/json' -d '{ "fuelConsumption":20, "hardStops":74371 }' 'http://user-java-service:80/api/user-java/aa1d876a-3e37-4a7a-8c9b-769ee6217ec2'
exit